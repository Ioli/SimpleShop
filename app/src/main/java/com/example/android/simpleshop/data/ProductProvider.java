...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String supplier_mail = values.getAsString(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME)) {
            String supplier_name = values.getAsString(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_NAME);
            if (supplier_name == null) {
                throw new IllegalArgumentException("Product requires valid name for supplier");
            }
        }
        ...
        if (values.containsKey(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL)) {
            String supplier_mail = values.getAsString(ProductContract.ProductEntry.COLUMN_PRODUCT_SUPPLIER_MAIL);
            if (supplier_mail == null) {
                throw new IllegalArgumentException("Product requires valid mail for supplier");
            }
        }
