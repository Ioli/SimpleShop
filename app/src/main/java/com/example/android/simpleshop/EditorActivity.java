...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentProductUri == null) {
            ...
            // Invalidate the options menu, so the "order" menu option can be hidden.
    ...
    private boolean saveProduct() {
        ...
        if (mCurrentProductUri == null &&
                TextUtils.isEmpty(nameString) && imageUri == null &&
        ...
        if (TextUtils.isEmpty(nameString)) {
            Toast.makeText(this, getString(R.string.namePicNull), Toast.LENGTH_SHORT).show();
            return check;
        }
        ...
        if (TextUtils.isEmpty(supplierNameString)) {
            Toast.makeText(this, getString(R.string.supplierPicNull), Toast.LENGTH_SHORT).show();
            return check;
        }
    ...
    public void minusClicked(View view) {
        if (mQuantity == 0) {
            Toast.makeText(this, getString(R.string.no_decrease_quantity), Toast.LENGTH_SHORT).show();
        } else {
            mQuantity--;
            displayQuantity();
        }
    ...
    public void orderProduct() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, mSupplierMailEditText.getText().toString().trim());
